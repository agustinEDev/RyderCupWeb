...
i18n
  ...
  .init({
    ...
    ns: ['common', 'auth', 'landing', 'dashboard', 'profile', 'competitions', 'devices', 'golfCourses', 'schedule', 'pricing', 'contact', 'legal', 'invitations', 'scoring', 'friends', 'quickMatch', 'admin', 'feed', 'playerProfile'], // Namespaces disponibles

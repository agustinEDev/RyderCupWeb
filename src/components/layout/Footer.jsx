          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div className="flex flex-col">
                <h3 className="text-gray-900 text-lg font-bold font-poppins">RyderCupFriends</h3>
                <span className="text-primary text-xs font-semibold -mt-1">RCF</span>
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-6">
              <a
                href="https://twitter.com/rydercupfriends"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-600 hover:text-primary hover:border-primary transition-all duration-200"
                aria-label="Twitter"
              >
              ...
              <a
                href="https://instagram.com/rydercupfriends"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-600 hover:text-primary hover:border-primary transition-all duration-200"
              ...
              <a
                href="https://facebook.com/rydercupfriends"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-600 hover:text-primary hover:border-primary transition-all duration-200"
                aria-label="Facebook"
              ...
              <a
                href="https://linkedin.com/company/rydercupfriends"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white border border-gray-300 rounded-full flex items-center justify-center text-gray-600 hover:text-primary hover:border-primary transition-all duration-200"
                aria-label="LinkedIn"

              ...
              >
                <div className="bg-gray-50 rounded-2xl p-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      <GithubIcon className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
                      <div>
